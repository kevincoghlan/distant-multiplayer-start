--This Firaxis script has been adjusted to utilise the 'Distant Multiplayer Start' mod.

------------------------------------------------------------------------------
include "DistantMultiplayerStart"
include "MapEnums"
...
function AssignStartingPlots:__InitStartingData()
	...
	-- If enabled, apply the 'Distant Multiplayer Start' mod logic.
	local distantHumanStartPositionsEnabled = MapConfiguration.GetValue("DISTANT_HUMAN_START_POSITIONS")
	if distantHumanStartPositionsEnabled then
	  print ("START OF 'DISTANT MULTIPLAYER START' MOD LOGIC")
